...
To skip the project selection step, set a default:

```
/ziggy setup PROJ
```

This sets the workspace default. You can also set a personal default:

```
/ziggy my-project MYPROJ
```

<Tip>Personal defaults override workspace defaults, so each team member can route tickets to their own project.</Tip>
